...
```{link-button} course-schedule-2021
:text: Spring 2021
:type: ref
...
- Read [“What Gets Counted Counts,”](https://data-feminism.mitpress.mit.edu/pub/h1w0nbqp/release/2) [*Data Feminism*](https://data-feminism.mitpress.mit.edu/), Lauren Klein and Catherine D'Ignazio 
...
- Recommended Reading: [“The Transformation of Gender in English-Language Fiction,”](https://culturalanalytics.org/article/11035) Ted Underwood, David Bamman, and Sabrina Lee

### Tues 4/7 — Twitter and the Right to Be Forgotten
* Discuss The Path Forward

* Recommended Reading: <a href="https://cmci.colorado.edu/~cafi5706/ICWSM2020_datascraping.pdf">No Robots, Spiders, or Scrapers: Legal and Ethical Regulation of Data Collection Methods in Social Media Terms of Service</a>, Casey Fiesler, Nathan Beard, Brian C. Keegan
...
- Read ["Demystifying Networks"](http://journalofdigitalhumanities.org/1-1/demystifying-networks-by-scott-weingart/), Scott Weingart
...
- Explore [Torn Apart / Separados](http://xpmethod.plaintext.in/torn-apart/volume/2/index), Manan Ahmed, Alex Gil, Moacir P. de Sá Pereira, <br>Roopika Risam, Maira E. Álvarez, Sylvia A. Fernández, Linda Rodriguez, and Merisa Martinez

- Read ['ICE Is Everywhere': Using Library Science to Map the Separation Crisis,](https://www.wired.com/story/ice-is-everywhere-using-library-science-to-map-child-separation/) Emily Dreyfuss
...
## **Final Project Homestretch**
---
### Tues 5/5 — Final Project
 

### Thu 5/7 — Final Project
