...
This website hosts the course materials for "Introduction to Cultural Analytics: Data, Computation & Culture," an undergraduate course taught at Cornell in the spring of 2020. It also includes an online textbook designed for the class.
...
Interact With This Book <How-To-Interact-With-This-Book>
```
...
1. The Command Line <Command-Line/The-Command-Line>
2. Python Basics <Python/Python>
3. Data Analysis (Pandas) <Data-Analysis/Data-Analysis>
4. Data Collection (Web Scraping, APIs) <Data-Collection/Data-Collection>
5. Text Analysis <Text-Analysis/Text-Analysis>
6. Network Analysis <Network-Analysis/Network-Analysis-Home>
7. Mapping <Mapping/Mapping-Home>
```
...
Python/Jupyter-Tips-Tricks
Make Random Student Groups <Python/Randomize-Students>
```
